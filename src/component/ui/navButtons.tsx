  ...
  <div className='bg-gray-100 px-4 py-3 sm:flex justify-end sm:px-6 gap-2'>
    ...
    {(!isFinally && renderNext) && (
      <button
        ...
        type='button'
        className={`w-full disabled:bg-gray-300 flex items-center gap-2 rounded-md bg-gray-600 disabled:bg-gray-400 px-3 py-2 text-white sm:w-auto ${clsx({
    ...
    {(isFinally) && (
      <button
        ...
        onClick={onSuccess}
        type='button'
        className='w-full justify-center flex items-center gap-2 rounded-md bg-gray-600 disabled:bg-gray-400 px-3 py-2 text-white sm:w-auto'>
