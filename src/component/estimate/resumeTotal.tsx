    ...
    <div className='flex flex-col'>
      <div className='grid grid-cols-2 gap-4'>
        <div className='p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
          <dt className='font-bold text-gray-600'>Actividades Totales</dt>
        ...
        <div className='p-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
          <dt className='font-bold text-gray-600'>Grupo de actividad</dt>
          <dd className='leading-6 text-gray-700 sm:col-span-2 sm:mt-0'>
      ...
      <div className='w-100 text-2xl gap-4 flex items-center justify-end m-8'>
